...
Again we check what the user has entered, and if it is the string   'quit', we \textbf{break} out of the loop, meaning execution   continues at the print statement.
